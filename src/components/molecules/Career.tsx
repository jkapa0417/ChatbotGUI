    ...
    <div className='flex flex-col p-4'>
      ...
      <div className="flex mt-4 gap-4 flex-wrap justify-center md:justify-start">
        {messages?.map((item, index) => (
          <Card key={index}>
            <div className="pl-14">
              <h2 className="text-2xl font-bold mb-2 text-gray-800">{item.company}</h2>
              <h3 className="text-xl font-semibold mb-3 text-blue-600">{item.position}</h3>
              ...
              <h4 className="text-lg font-medium mb-2 text-gray-700">Key Responsibilities:</h4>
