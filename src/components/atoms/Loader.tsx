/*Pencil Loader code provied by https://codepen.io/Shashank-mohan/pen/KKrpvpB modified into react version*/
        ...
        <g transform="translate(100,100)" className="pencil__rotate">
          ...
          <g transform="rotate(-90) translate(49,0)" className="pencil__eraser">
            <g className="pencil__eraser-skew">
              <rect height="30" width="30" ry="5" rx="5" fill="	hsl(342, 100%, 70%)"></rect>
              <rect clipPath="url(#pencil-eraser)" height="30" width="5" fill="	hsl(342, 100%, 60%)"></rect>
